// InvoiceReceiptGallery.jsx
import React, { useEffect, useState } from 'react';
import { storage } from '../firebase';
import { ref, uploadBytes, getDownloadURL, deleteObject } from "firebase/storage";

const InvoiceReceiptGallery = ({
    ...
    return (
        <section className="upload-section invoice-upload-section">
            <h3 className="receipt-section-title invoice-title">{sectionTitle}</h3>

            <div className="upload-receipt-wrapper">
                <input type="file" onChange={handleFileChange} />
                <button
                    className="upload-btn invoice-upload-btn"
...
export default InvoiceReceiptGallery;
